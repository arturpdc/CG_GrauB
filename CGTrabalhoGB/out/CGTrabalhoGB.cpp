...
glm::vec4 colorList[] = {
    {0.5f, 0.5f, 0.5f, 0.5f}, // cinza -- reservado para a interface
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Novo: desenha apenas as linhas do cubo externo
        glBindVertexArray(wireVAO);
        glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
        setColor(shaderID, glm::vec4(1.0f, 1.0f, 1.0f, 0.2f)); // branco suave
